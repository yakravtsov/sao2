...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['email', 'company_id'], 'required', 'on' => 'signup'],
            ...
            ['role_id', 'in', 'range' => [self::ROLE_WORKER, self:: ROLE_CLIENT, self::ROLE_ADMINISTRATOR], 'on' => 'signup'],
        ];
    }
    ...
    {
        return [
            'signup' => ['user_id', 'email', 'password', '!status', '!role', 'role_id', 'phio', 'company_id', 'parent_id'],
            'default' => [],
